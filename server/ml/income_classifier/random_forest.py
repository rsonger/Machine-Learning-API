...
class RandomForestClassifier:
    '''
    A wrapper for the Random Forest model stored in the `training` folder.
    ...
    def __init__(self):
        ...
        self.model = joblib.load(Path(path_to_artifacts, "random_forest.joblib"))
    ...
    def predict(self, input_data):
        '''
        Use this Random Forest model to predict probabilities for income classes from the given data.
